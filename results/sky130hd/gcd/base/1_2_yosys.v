...
module \ALU_16_0_16_0_16_unused_CO[14:0]_X_HAN_CARLSON (A, B, BI, CI, Y, \CO[15] );
  ...
  sky130_fd_sc_hd__a221oi_1 _115_ (
    .A1(_012_),
    .A2(_021_),
    .B1(_022_),
    .B2(_003_),
...
module gcd(clk, req_msg, req_rdy, req_val, reset, resp_msg, resp_rdy, resp_val);
  ...
  wire _118_;
  (* implements_operator = "ALU_16_0_16_0_16_unused_CO[14:0]_X" *)
  (* src = "/OpenROAD-flow-scripts/flow/designs/src/gcd/gcd.v:752.12-752.19" *)
  \ALU_16_0_16_0_16_unused_CO[14:0]_X_HAN_CARLSON  _119_ (
    .A({ _001_, _019_, _020_, _021_, _022_, _023_, _024_, _025_, _026_, _027_, _028_, _029_, _030_, _031_, _033_, _034_ }),
    .B({ _035_, _004_, _005_, _006_, _007_, _008_, _009_, _010_, _011_, _012_, _013_, _014_, _015_, _016_, _017_, _018_ }),
    .BI(_000_),
    .CI(_000_),
    .\CO[15] (_032_),
    .Y(resp_msg)
  ...
  sky130_fd_sc_hd__o21bai_1 _123_ (
    .A1(_037_),
    .A2(_032_),
    .B1_N(req_rdy),
    .Y(_038_)
