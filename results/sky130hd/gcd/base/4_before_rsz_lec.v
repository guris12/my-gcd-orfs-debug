module gcd (clk,
 ...
 sky130_fd_sc_hd__clkinv_1 _122_ (.A(net239),
    .Y(_037_));
 sky130_fd_sc_hd__o21bai_4 _123_ (.A1(_032_),
    .A2(_037_),
    .B1_N(net241),
    .Y(_038_));
 sky130_fd_sc_hd__mux2_1 _124_ (.A0(net234),
    .A1(net9),
    .S(net241),
    .X(_039_));
 sky130_fd_sc_hd__or2_4 _125_ (.A(_002_),
    .B(net38),
    .X(_040_));
 sky130_fd_sc_hd__nand2b_1 _126_ (.A_N(net241),
    .B(net239),
    .Y(_041_));
 sky130_fd_sc_hd__mux2i_1 _127_ (.A0(net223),
    .A1(net39),
    .S(net154),
    .Y(_042_));
 sky130_fd_sc_hd__nand2_1 _128_ (.A(net10),
    .B(net193),
    .Y(_043_));
 sky130_fd_sc_hd__o21ai_0 _129_ (.A1(net193),
    .A2(_042_),
    .B1(_043_),
    .Y(_044_));
 ...
 sky130_fd_sc_hd__nand2_1 _131_ (.A(net11),
    .B(net193),
    .Y(_046_));
 sky130_fd_sc_hd__o21ai_0 _132_ (.A1(net193),
    .A2(_045_),
    .B1(_046_),
    .Y(_047_));
 ...
 sky130_fd_sc_hd__nand2_1 _134_ (.A(net12),
    .B(net193),
    .Y(_049_));
 sky130_fd_sc_hd__o21ai_0 _135_ (.A1(net193),
    .A2(_048_),
    .B1(_049_),
    .Y(_050_));
 ...
 sky130_fd_sc_hd__nand2_1 _137_ (.A(net13),
    .B(net193),
    .Y(_052_));
 sky130_fd_sc_hd__o21ai_0 _138_ (.A1(net193),
    .A2(_051_),
    .B1(_052_),
    .Y(_053_));
 ...
 sky130_fd_sc_hd__nand2_1 _140_ (.A(net15),
    .B(net193),
    .Y(_055_));
 sky130_fd_sc_hd__o21ai_0 _141_ (.A1(net193),
    .A2(_054_),
    .B1(_055_),
    .Y(_056_));
 ...
 sky130_fd_sc_hd__nand2_1 _143_ (.A(net16),
    .B(net193),
    .Y(_058_));
 sky130_fd_sc_hd__o21ai_0 _144_ (.A1(net193),
    .A2(_057_),
    .B1(_058_),
    .Y(_059_));
 ...
 sky130_fd_sc_hd__nand2_1 _146_ (.A(net17),
    .B(net194),
    .Y(_061_));
 sky130_fd_sc_hd__o21ai_0 _147_ (.A1(net194),
    .A2(_060_),
    .B1(_061_),
    .Y(_062_));
 ...
 sky130_fd_sc_hd__nand2_1 _149_ (.A(net18),
    .B(net194),
    .Y(_064_));
 sky130_fd_sc_hd__o21ai_0 _150_ (.A1(net194),
    .A2(_063_),
    .B1(_064_),
    .Y(_065_));
 ...
 sky130_fd_sc_hd__nand2_1 _152_ (.A(net19),
    .B(net194),
    .Y(_067_));
 sky130_fd_sc_hd__o21ai_0 _153_ (.A1(net194),
    .A2(_066_),
    .B1(_067_),
    .Y(_068_));
 ...
 sky130_fd_sc_hd__nand2_1 _155_ (.A(net20),
    .B(net194),
    .Y(_070_));
 sky130_fd_sc_hd__o21ai_0 _156_ (.A1(net194),
    .A2(_069_),
    .B1(_070_),
    .Y(_071_));
 ...
 sky130_fd_sc_hd__nand2_1 _158_ (.A(net21),
    .B(net194),
    .Y(_073_));
 sky130_fd_sc_hd__o21ai_0 _159_ (.A1(net194),
    .A2(_072_),
    .B1(_073_),
    .Y(_074_));
 ...
 sky130_fd_sc_hd__nand2_1 _161_ (.A(net22),
    .B(net193),
    .Y(_076_));
 sky130_fd_sc_hd__o21ai_0 _162_ (.A1(net193),
    .A2(_075_),
    .B1(_076_),
    .Y(_077_));
 ...
 sky130_fd_sc_hd__nand2_1 _164_ (.A(net23),
    .B(net193),
    .Y(_079_));
 sky130_fd_sc_hd__o21ai_0 _165_ (.A1(net193),
    .A2(_078_),
    .B1(_079_),
    .Y(_080_));
 ...
 sky130_fd_sc_hd__nand2_1 _167_ (.A(net24),
    .B(net194),
    .Y(_082_));
 sky130_fd_sc_hd__o21ai_0 _168_ (.A1(net194),
    .A2(_081_),
    .B1(_082_),
    .Y(_083_));
 ...
 sky130_fd_sc_hd__nand2_1 _170_ (.A(net26),
    .B(net193),
    .Y(_085_));
 sky130_fd_sc_hd__o21ai_0 _171_ (.A1(net193),
    .A2(_084_),
    .B1(_085_),
    .Y(_086_));
 sky130_fd_sc_hd__mux2_1 _172_ (.A0(_034_),
    ...
    .S(net240),
    .X(_087_));
 sky130_fd_sc_hd__mux2_1 _173_ (.A0(net233),
    .A1(net14),
    .S(net240),
    .X(_088_));
 sky130_fd_sc_hd__mux2_1 _174_ (.A0(net232),
    .A1(net25),
    .S(net240),
    .X(_089_));
 sky130_fd_sc_hd__mux2_1 _175_ (.A0(net231),
    .A1(net28),
    .S(net240),
    .X(_090_));
 sky130_fd_sc_hd__mux2_1 _176_ (.A0(net230),
    .A1(net29),
    .S(net240),
    .X(_091_));
 sky130_fd_sc_hd__mux2_1 _177_ (.A0(net229),
    .A1(net30),
    .S(net240),
    .X(_092_));
 sky130_fd_sc_hd__mux2_1 _178_ (.A0(net228),
    .A1(net31),
    .S(net240),
    .X(_093_));
 sky130_fd_sc_hd__mux2_1 _179_ (.A0(net226),
    .A1(net32),
    .S(net241),
    .X(_094_));
 sky130_fd_sc_hd__mux2_1 _180_ (.A0(net225),
    .A1(net33),
    .S(net241),
    .X(_095_));
 sky130_fd_sc_hd__mux2_1 _181_ (.A0(net224),
    .A1(net34),
    .S(net241),
    .X(_096_));
 sky130_fd_sc_hd__mux2_1 _182_ (.A0(net237),
    .A1(net4),
    .S(net241),
    .X(_097_));
 sky130_fd_sc_hd__mux2_1 _183_ (.A0(net236),
    .A1(net5),
    .S(net240),
    .X(_098_));
 sky130_fd_sc_hd__mux2_1 _184_ (.A0(net235),
    .A1(net6),
    .S(net240),
    .X(_099_));
 ...
 sky130_fd_sc_hd__a221o_1 _188_ (.A1(_112_),
    ...
    .C1(net36),
    .X(_102_));
 sky130_fd_sc_hd__nor2b_1 _189_ (.A(net241),
    .B_N(net37),
    .Y(_103_));
 ...
 sky130_fd_sc_hd__and4_1 _194_ (.A(net192),
    ...
    .D(_107_),
    .X(_108_));
 sky130_fd_sc_hd__nand2_1 _195_ (.A(_108_),
    .B(net157),
    .Y(_109_));
 sky130_fd_sc_hd__a21oi_1 _196_ (.A1(net157),
    .A2(_108_),
    .B1(_003_),
    .Y(_110_));
 ...
 sky130_fd_sc_hd__nor2b_1 _199_ (.A(net242),
    .B_N(_111_),
    .Y(_113_));
 sky130_fd_sc_hd__a22oi_1 _200_ (.A1(net243),
    .A2(net241),
    .B1(_109_),
    .B2(net239),
    .Y(_114_));
 ...
 sky130_fd_sc_hd__nand2_1 _203_ (.A(net27),
    .B(net194),
    .Y(_117_));
 sky130_fd_sc_hd__o21ai_0 _204_ (.A1(net194),
    .A2(_116_),
    .B1(_117_),
    .Y(_118_));
 ...
 sky130_fd_sc_hd__clkdlybuf4s50_1 input9 (.A(req_msg[15]),
    .X(net9));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output38 (.A(net241),
    .X(req_rdy));
 ...
 sky130_fd_sc_hd__buf_12 place137 (.A(_032_),
    .X(net154));
 sky130_fd_sc_hd__buf_4 place138 (.A(_032_),
    .X(net155));
 sky130_fd_sc_hd__buf_4 place139 (.A(_032_),
    .X(net156));
 sky130_fd_sc_hd__buf_4 place140 (.A(_032_),
    .X(net157));
 ...
 sky130_fd_sc_hd__buf_4 place177 (.A(_041_),
    .X(net194));
 sky130_fd_sc_hd__buf_4 place178 (.A(_040_),
    .X(net195));
 ...
 sky130_fd_sc_hd__buf_4 place194 (.A(_012_),
    .X(net211));
 sky130_fd_sc_hd__buf_4 place195 (.A(_013_),
    .X(net212));
 sky130_fd_sc_hd__buf_4 place196 (.A(_014_),
    .X(net213));
 sky130_fd_sc_hd__buf_4 place197 (.A(_015_),
    .X(net214));
 sky130_fd_sc_hd__buf_4 place198 (.A(_016_),
    .X(net215));
 ...
 sky130_fd_sc_hd__buf_4 place213 (.A(_029_),
    .X(net230));
 sky130_fd_sc_hd__buf_4 place214 (.A(_030_),
    .X(net231));
 ...
 sky130_fd_sc_hd__buf_4 place221 (.A(_002_),
    .X(net239));
 sky130_fd_sc_hd__buf_12 place222 (.A(net241),
    .X(net240));
 sky130_fd_sc_hd__buf_4 place223 (.A(net38),
    .X(net241));
...
module \ALU_16_0_16_0_16_unused_CO[14:0]_X_KOGGE_STONE  (_023__238,
 ...
 sky130_fd_sc_hd__a21oi_1 _129_ (.A1(_114_),
    ...
    .B1(_000_),
    .Y(_001_));
 sky130_fd_sc_hd__o311ai_1 _130_ (.A1(_126_),
    .A2(_110_),
    .A3(_091_),
    .B1(_127_),
    .C1(_001_),
    .Y(_002_));
 sky130_fd_sc_hd__xnor2_1 _131_ (.A(net182),
    .B(_002_),
    .Y(Y[15]));
 ...
 sky130_fd_sc_hd__nand2_1 _133_ (.A(net227),
    .B(net207),
    .Y(_004_));
 sky130_fd_sc_hd__xnor2_2 _134_ (.A(A[6]),
    .B(_003_),
    .Y(_005_));
 ...
 sky130_fd_sc_hd__nand2_1 _139_ (.A(_029__134),
    .B(_009_),
    .Y(_010_));
 sky130_fd_sc_hd__xnor2_2 _140_ (.A(_007_),
    .B(A[5]),
    .Y(_011_));
 sky130_fd_sc_hd__o21ai_1 _141_ (.A1(_010_),
    .A2(_011_),
    .B1(_008_),
    .Y(_012_));
 ...
 sky130_fd_sc_hd__nand2_1 _143_ (.A(_106_),
    .B(_013_),
    .Y(_014_));
 sky130_fd_sc_hd__a21oi_2 _144_ (.A1(net177),
    .A2(net176),
    .B1(_014_),
    .Y(_015_));
 sky130_fd_sc_hd__xnor3_1 _145_ (.A(A[4]),
    .B(BI),
    .C(B[4]),
    .X(_016_));
 sky130_fd_sc_hd__nor2_1 _146_ (.A(_011_),
    .B(_016_),
    .Y(_017_));
 ...
 sky130_fd_sc_hd__nand2_1 _149_ (.A(_030__136),
    .B(_019_),
    .Y(_020_));
 sky130_fd_sc_hd__xnor3_1 _150_ (.A(BI),
    .B(B[3]),
    .C(A[3]),
    .X(_021_));
 sky130_fd_sc_hd__xor2_1 _151_ (.A(B[2]),
    .B(BI),
    .X(_022_));
 ...
 sky130_fd_sc_hd__xor3_1 _153_ (.A(A[2]),
    ...
    .C(BI),
    .X(_024_));
 sky130_fd_sc_hd__xnor2_1 _154_ (.A(_031__138),
    .B(_022_),
    .Y(_025_));
 sky130_fd_sc_hd__nor2_1 _155_ (.A(net204),
    .B(_025_),
    .Y(_026_));
 ...
 sky130_fd_sc_hd__nand2_1 _157_ (.A(_033__140),
    .B(_027_),
    .Y(_028_));
 sky130_fd_sc_hd__xnor2_2 _158_ (.A(B[0]),
    .B(BI),
    .Y(_029_));
 sky130_fd_sc_hd__xnor2_1 _159_ (.A(net201),
    .B(net203),
    .Y(_030_));
 ...
 sky130_fd_sc_hd__clkinv_1 _164_ (.A(A[0]),
    .Y(_035_));
 sky130_fd_sc_hd__o21ai_1 _165_ (.A1(net205),
    .A2(_023_),
    .B1(_020_),
    .Y(_036_));
 sky130_fd_sc_hd__a21oi_2 _166_ (.A1(_026_),
    .A2(net174),
    .B1(net173),
    .Y(_037_));
 sky130_fd_sc_hd__o21ai_2 _167_ (.A1(_037_),
    .A2(_018_),
    .B1(_015_),
    .Y(_038_));
 ...
 sky130_fd_sc_hd__xnor2_1 _173_ (.A(A[10]),
    .B(_042_),
    .Y(_044_));
 sky130_fd_sc_hd__nor2_1 _174_ (.A(_041_),
    .B(_044_),
    .Y(_045_));
 ...
 sky130_fd_sc_hd__nand2_1 _176_ (.A(_024__124),
    .B(_046_),
    .Y(_047_));
 sky130_fd_sc_hd__xnor3_1 _177_ (.A(BI),
    .B(B[9]),
    .C(A[9]),
    .X(_048_));
 ...
 sky130_fd_sc_hd__nand2_1 _179_ (.A(_025__126),
    .B(_049_),
    .Y(_050_));
 sky130_fd_sc_hd__xnor3_1 _180_ (.A(A[8]),
    .B(B[8]),
    .C(BI),
    .X(_051_));
 ...
 sky130_fd_sc_hd__a21o_4 _205_ (.A1(_068_),
    ...
    .B1(_075_),
    .X(\CO[15] ));
 sky130_fd_sc_hd__xnor2_1 _206_ (.A(CI),
    .B(_030_),
    .Y(Y[0]));
 sky130_fd_sc_hd__xnor2_1 _207_ (.A(net202),
    .B(net186),
    .Y(Y[1]));
 sky130_fd_sc_hd__xnor2_1 _208_ (.A(net174),
    .B(_025_),
    .Y(Y[2]));
 ...
 sky130_fd_sc_hd__o211ai_1 _211_ (.A1(_031_),
    ...
    .C1(_023_),
    .Y(_078_));
 sky130_fd_sc_hd__xnor2_1 _212_ (.A(net168),
    .B(net204),
    .Y(Y[3]));
 sky130_fd_sc_hd__xor2_1 _213_ (.A(_016_),
    .B(net165),
    .X(Y[4]));
 sky130_fd_sc_hd__or2_1 _214_ (.A(_016_),
    .B(_021_),
    .X(_079_));
 sky130_fd_sc_hd__o21ai_0 _215_ (.A1(_016_),
    .A2(_020_),
    .B1(_010_),
    .Y(_080_));
 sky130_fd_sc_hd__nor3_2 _216_ (.A(_031_),
    .B(_079_),
    .C(net179),
    .Y(_081_));
 sky130_fd_sc_hd__a21oi_2 _217_ (.A1(_023_),
    .A2(_077_),
    .B1(_079_),
    .Y(_082_));
 sky130_fd_sc_hd__nor3_1 _218_ (.A(_080_),
    ...
    .C(_081_),
    .Y(_083_));
 sky130_fd_sc_hd__xor2_1 _219_ (.A(net188),
    .B(_083_),
    .X(Y[5]));
 sky130_fd_sc_hd__nor4_1 _220_ (.A(_011_),
    .B(_016_),
    .C(_021_),
    .D(_025_),
    .Y(_084_));
 sky130_fd_sc_hd__clkinv_1 _221_ (.A(CI),
    .Y(_085_));
 sky130_fd_sc_hd__a221oi_1 _222_ (.A1(_017_),
    .A2(_036_),
    .B1(_084_),
    .B2(_034_),
    .C1(_012_),
    .Y(_086_));
 sky130_fd_sc_hd__xor2_1 _223_ (.A(net189),
    .B(net162),
    .X(Y[6]));
 sky130_fd_sc_hd__nor2_1 _224_ (.A(_005_),
    .B(net187),
    .Y(_087_));
 sky130_fd_sc_hd__nor3_1 _225_ (.A(_005_),
    .B(net187),
    .C(_079_),
    .Y(_088_));
 ...
 sky130_fd_sc_hd__a221oi_2 _228_ (.A1(_080_),
    ...
    .C1(_090_),
    .Y(_091_));
 sky130_fd_sc_hd__xor2_1 _229_ (.A(net178),
    .B(net161),
    .X(Y[7]));
 sky130_fd_sc_hd__xnor2_1 _230_ (.A(_038_),
    .B(net199),
    .Y(Y[8]));
 ...
 sky130_fd_sc_hd__nor2_1 _235_ (.A(_093_),
    .B(net167),
    .Y(_096_));
 sky130_fd_sc_hd__nor4_1 _236_ (.A(_119_),
    .B(_005_),
    .C(net188),
    .D(_051_),
    .Y(_097_));
 sky130_fd_sc_hd__o31ai_1 _237_ (.A1(_080_),
    .A2(_082_),
    .A3(_081_),
    .B1(_097_),
    .Y(_098_));
 sky130_fd_sc_hd__nand2_1 _238_ (.A(net160),
    .B(_096_),
    .Y(_099_));
 sky130_fd_sc_hd__xnor2_1 _239_ (.A(_048_),
    .B(_099_),
    .Y(Y[9]));
 ...
 sky130_fd_sc_hd__nand2_1 _243_ (.A(net177),
    .B(net183),
    .Y(_103_));
 sky130_fd_sc_hd__o21ai_0 _244_ (.A1(net163),
    .A2(_103_),
    .B1(_101_),
    .Y(_104_));
 sky130_fd_sc_hd__xnor2_1 _245_ (.A(net184),
    .B(_104_),
    .Y(Y[10]));
 ...
 sky130_fd_sc_hd__nand2_1 _251_ (.A(_092_),
    .B(_105_),
    .Y(_110_));
 sky130_fd_sc_hd__o21ai_1 _252_ (.A1(_091_),
    .A2(_110_),
    .B1(_109_),
    .Y(_111_));
 sky130_fd_sc_hd__xnor2_1 _253_ (.A(net185),
    .B(_111_),
    .Y(Y[11]));
 sky130_fd_sc_hd__nand4_1 _254_ (.A(net177),
    ...
    .D(net183),
    .Y(_112_));
 sky130_fd_sc_hd__o221ai_1 _255_ (.A1(_015_),
    .A2(_053_),
    .B1(_112_),
    .B2(_037_),
    .C1(_073_),
    .Y(_113_));
 sky130_fd_sc_hd__xnor2_1 _256_ (.A(net180),
    .B(_113_),
    .Y(Y[12]));
 ...
 sky130_fd_sc_hd__a21oi_1 _267_ (.A1(_066_),
    ...
    .B1(net170),
    .Y(_123_));
 sky130_fd_sc_hd__o211ai_1 _268_ (.A1(net163),
    .A2(_121_),
    .B1(_122_),
    .C1(_123_),
    .Y(_124_));
 sky130_fd_sc_hd__xnor2_1 _269_ (.A(net181),
    .B(_124_),
    .Y(Y[14]));
 ...
 sky130_fd_sc_hd__o211ai_1 _272_ (.A1(_107_),
    ...
    .C1(net166),
    .Y(_127_));
 sky130_fd_sc_hd__buf_4 place143 (.A(_098_),
    .X(net160));
 sky130_fd_sc_hd__buf_4 place144 (.A(_091_),
    .X(net161));
 sky130_fd_sc_hd__buf_4 place145 (.A(net163),
    .X(net162));
 sky130_fd_sc_hd__buf_4 place146 (.A(_086_),
    .X(net163));
 sky130_fd_sc_hd__buf_4 place147 (.A(_053_),
    .X(net164));
 sky130_fd_sc_hd__buf_4 place148 (.A(_037_),
    .X(net165));
 sky130_fd_sc_hd__buf_4 place149 (.A(_125_),
    .X(net166));
 sky130_fd_sc_hd__buf_4 place150 (.A(_095_),
    .X(net167));
 sky130_fd_sc_hd__buf_4 place151 (.A(_078_),
    .X(net168));
 ...
 sky130_fd_sc_hd__buf_4 place156 (.A(_036_),
    .X(net173));
 sky130_fd_sc_hd__buf_4 place157 (.A(_034_),
    .X(net174));
 ...
 sky130_fd_sc_hd__buf_4 place168 (.A(_041_),
    .X(net185));
 sky130_fd_sc_hd__buf_4 place169 (.A(_031_),
    .X(net186));
 sky130_fd_sc_hd__buf_4 place170 (.A(_011_),
    .X(net187));
 ...
 sky130_fd_sc_hd__buf_4 place187 (.A(net205),
    .X(net204));
 sky130_fd_sc_hd__buf_4 place188 (.A(_021_),
    .X(net205));
